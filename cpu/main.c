...
uint32_t main(void){
    ...
    recv_tamanio_y_cant_entradas(socket_memoria_cpu, &tamanio_pagina, &cant_entradas_por_tabla); //recibo el tamano de la pagina y la cantidad de entradas por tabla que me manda la memoria
